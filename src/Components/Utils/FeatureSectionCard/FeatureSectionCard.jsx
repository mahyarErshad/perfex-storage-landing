...
function FeatureSectionCard({ gradientFrom, gradientTo }) {
  return (
    <div className="flex-col py-10 px-4 glass-container rounded-20 w-full relative">
      <span className={`absolute -top-1 w-[80%] right-[10%] h-1 rounded-[0.3125rem] bg-gradient-to-r ${gradientFrom} ${gradientTo}`}></span>
