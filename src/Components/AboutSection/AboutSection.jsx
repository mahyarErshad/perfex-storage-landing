...
function AboutSection() {
  return (
    <section className="container mt-[6.5rem] mb-32 flex-center">
      <SectionHeading title="درباره ماژول انبارداری" />
      <div className="mt-8 glass-container pt-10 w-full flex-col flex-center rounded-20 border border-[#ffffff29]">
