  ...
  return (
    <section className="container flex-center mb-[9.5rem] gap-10">
      ...
      <div className="grid lg:grid-cols-4 md:grid-cols-2 max-md:grid-cols-1 gap-6 w-full">
        ...
        <FeatureSectionCard title="بهبود روابط تامین کننده و مشتری" description="ماژول انبارداری اسکریپت پرفکس با امکان  مدیریت چندین انبار و محصولات انبارها ، با قابلیت هایی مانند ایجاد حواله خروج،لیست کردن کالاهای آسیب دیده وبرگشت از فروش و... تحویل صحیح  هرمرسوله به مشتری تسریع می بخشد و با مدیریت درست تنش های بین تامین کننده و مشتری ،مبنی بر ارسال مرسوله اشتباه،آسیب به مرسوله و حمل نقل مرسوله را  کاهش می دهد." gradient="from-[#FBAB7E] to-[#F7CE68]" />
      </div>
    </section>
  );
}
